...
#include "EdGraphSchema_KRGDialogue.generated.h"

/**
 * 
 */
UCLASS()
class KRGDIALOGUEEDITOR_API UEdGraphSchema_KRGDialogue : public UEdGraphSchema
{
	GENERATED_BODY()
	
public:
	void GetBreakLinkToSubMenuActions(class UToolMenu* Menu, class UEdGraphPin* InEdGraphPin);
